    ...
    <div className="font color-body ">
      <Container>
        <BrowserRouter>
          ...
          <Routes>
            <Route path="/movies-site/" element={<MoviesList movies={movies} getPage={getPage} pageCount={pageCount} setpagecount={setpageCount} setmovies={setMovies} />} />
            <Route path="/movies-site/movie/:id" element={<MovieDetails />} />
